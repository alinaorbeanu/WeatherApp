...
public interface UserController {
    ...
    ResponseEntity<UserDTO> add(HttpServletRequest request, @Valid @RequestBody UserDTO userDTO);
    ...
    ResponseEntity<UserDTO> findById(HttpServletRequest request, @Positive @PathVariable Long id);
    ...
    ResponseEntity<?> delete(HttpServletRequest request, @Positive @PathVariable Long id);
    ...
    ResponseEntity<UserDTO> findByEmail(HttpServletRequest request, @Positive @PathVariable String email);
