...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {EmailAlreadyExistsException.class, ConstraintViolationException.class, PSQLException.class})
    ...
    public ResponseEntity<Object> handleHeaderAuthorizationException(RuntimeException e) {
        ApiError apiError = new ApiError(HttpStatus.UNAUTHORIZED, e.getMessage(), LocalDateTime.now());
        return new ResponseEntity<>(apiError, HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(value = {AuthenticationException.class})
    public ResponseEntity<Object> handleHeaderAuthorizationException(AuthenticationException e) {
        ApiError apiError = new ApiError(HttpStatus.FORBIDDEN, e.getMessage(), LocalDateTime.now());
